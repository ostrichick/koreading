                    ...
                    {LANG_OPTIONS.map(lang => (
                      <button
                        ...
                        style={{
                          ...
                          background: currentLang === lang.value ? 'rgba(217,119,6,0.12)' : 'transparent',
                  ...
                  return (
                    <label
                      ...
                      style={{
                        ...
                        gap: '10px',
                        padding: '12px',
                        background: checked ? 'rgba(217,119,6,0.08)' : 'var(--bg-secondary)',
                        border: '1px solid',
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        gap: '6px',
                        padding: '10px 6px',
                        background: active ? 'rgba(217,119,6,0.12)' : 'var(--bg-secondary)',
                        border: '1px solid',
