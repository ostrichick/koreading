...
export const KOREAN_CURRICULUM: Record<CEFRLevel, LevelCurriculum> = {
  ...
  B1: {
    ...
    targetAudience: '일상생활의 대부분을 한국어로 해결할 수 있으며 자신의 생각과 경험을 구체적으로 설명하고 싶은 학습자',
    targetGrammar: [
      '-(으)ㄴ 적이 있다/없다 (과거 경험)',
      '-기 때문에 (명확한 이유 설명)',
    ...
    sentenceConstraint: '한 문장당 8~12개 단어로 구성된 다채로운 복문. 3개의 논리적 문단. 형용사와 부사를 풍부하게 사용하여 감정과 상황을 묘사.',
    lengthConstraint: '약 800~1000자 내외.',
    situationalFocus: '한국 여행 경험기, K-드라마/영화 감상평, 취미와 직장 생활, 한국의 독특한 배달/카페 문화 체험, 고민 상담.',
  },
  B2: {
    name: '중급 2',
...
3. 핵심 어휘 반복 각인 원칙 (Vocabulary Recycling - CRITICAL):
...
5. 언어학자 스티븐 크라센(Stephen Krashen)의 i+1 원리:
   - 텍스트의 90%는 학습자 레벨에서 편안하게 읽히는 친숙한 단어로 구성하고, 10%의 새로운 핵심 어휘와 목표 문법으로 지적 성장을 이끌어내십시오.
`;
}
